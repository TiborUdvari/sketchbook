...
// todo - add different colors for each face
// todo - enable backface culling
// todo - enable DEPTH_BUFFER
// todo - understand projection matrix into clip space
...
let mat = m4.identity();
let proj = m4.projection(gl.canvas.width, gl.canvas.height, 900);
...
proj = m4.orthographic(left, right, bottom, top, near, far);

mat = m4.multiply(mat, proj);
mat = m4.multiply(mat, m4.translation(gl.canvas.width * .5, gl.canvas.height * .5, 0));
// mat = m4.multiply(mat, m4.zRotation(Math.PI * 2 * 0.20));
let projCenterMatrix = mat;
