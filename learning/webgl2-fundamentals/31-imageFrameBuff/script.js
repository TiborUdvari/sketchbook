...
// todo 1 – create a fbo, draw into it and then into the screen
...
try {
  ...
  img2 = await loadImage('../assets/corgi2.jpg');
...
// draw the texture with the fbo
// use the resulting texture in the main output


let fboTex = createTexture();
gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, img2.width, img2.height, 0, gl.RGBA, gl.UNSIGNED_BYTE, null);

let inputTex = createTexture();
gl.texImage2D(gl.TEXTURE_2D, 0, gl.RGBA, img2.width, img2.height, 0, gl.RGBA, gl.UNSIGNED_BYTE, img2);
...
gl.uniform2fv(
  ...
  new Float32Array([img2.width, img2.height])
);
