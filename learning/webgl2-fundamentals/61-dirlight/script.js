...
let fragmentShaderSource = `#version 300 es
  ...
  void main() {
      float intensity = dot(u_reverseLightDirection, v_normal);
      outColor = vec4(u_color.xyz * intensity, 1.0);
  }
`;
...
function main() {
  ...
  for (let i = 0; i < n; i++){
    ...
    gl.uniform3fv(reverseLightDirectionLocation, reverseLightDirection);
